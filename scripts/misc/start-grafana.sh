...
GRAFANA_CONFIG_FILE="${DEV_BALLERINA_CURRENT_SCRIPT_DIR}/resources/grafana/config.yml"
GRAFANA_DASHBOARD_JSON="${DEV_BALLERINA_CURRENT_SCRIPT_DIR}/resources/grafana/ballerina-dashboard.json"
